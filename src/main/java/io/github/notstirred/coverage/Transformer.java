...
public class Transformer implements ClassFileTransformer {
    ...
    @Override
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] clazz) throws IllegalClassFormatException {
        if (!(className.startsWith("net/minecraft") || className.startsWith("io/github/opencubicchunks"))) {
            return clazz;
        }
